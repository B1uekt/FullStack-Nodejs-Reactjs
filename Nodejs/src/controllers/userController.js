const { createUser, loginService, getUserService, addNewUser, deleteUserwithId } = require("../services/userService")
...
module.exports = { CreateUser, handleLogin, getUser, postAddNewUser, deleteUser }